...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.ParamFlowRuleProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.ParamFlowRulePublisher;
...
//    private SentinelApiClient sentinelApiClient;
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(HttpServletRequest request,
        ...
        try {
            List<ParamFlowRuleEntity> rules = this.paramFlowRuleProvider.getRules(app, ip, port.toString());
            CompletableFuture<List<ParamFlowRuleEntity>> completableFuture = new CompletableFuture<>();
            completableFuture.complete(rules);
    ...
    private CompletableFuture<Void> publishRules(String app, String ip, Integer port) {
        ...
        try {
            this.paramFlowRulePublisher.publish(app, rules);
        } catch (Exception e) {
