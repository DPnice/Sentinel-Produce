...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.AuthorityRuleProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.AuthorityRulePublisher;
...
public class AuthorityRuleController {
    ...
    public Result<List<AuthorityRuleEntity>> apiQueryAllRulesForMachine(HttpServletRequest request,
        ...
        try {
            ...
            List<AuthorityRuleEntity> rules = this.authorityRuleProvider.getRules(app);
    ...
    private boolean publishRules(String app, String ip, Integer port) {
        ...
        try {
            ...
            this.authorityRulePublisher.publish(app, rules);
            return true;
        } catch (Exception e) {
            return false;
        }
