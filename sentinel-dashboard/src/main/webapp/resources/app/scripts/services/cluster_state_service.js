...
angular.module('sentinelDashboardApp').service('ClusterStateService', ['$http', function ($http) {
    ...
    this.fetchClusterUniversalStateSingle = function(app, ip, port) {
        ...
        return $http({
            url: '/sentinel/cluster/state_single',
            params: param,
            method: 'GET'
        });
    };
    ...
    this.fetchClusterUniversalStateOfApp = function(app) {
        return $http({
            url: '/sentinel/cluster/state/' + app,
            method: 'GET'
        });
    };
    ...
    this.fetchClusterServerStateOfApp = function(app) {
        return $http({
            url: '/sentinel/cluster/server_state/' + app,
            method: 'GET'
        });
    };
    ...
    this.fetchClusterClientStateOfApp = function(app) {
        return $http({
            url: '/sentinel/cluster/client_state/' + app,
            method: 'GET'
        });
    };
    ...
    this.modifyClusterConfig = function(config) {
        return $http({
            url: '/sentinel/cluster/config/modify_single',
            data: config,
            method: 'POST'
        });
    };
    ...
    this.applyClusterFullAssignOfApp = function(app, clusterMap) {
        return $http({
            url: '/sentinel/cluster/assign/all_server/' + app,
            data: clusterMap,
            method: 'POST'
        });
    };
    ...
    this.applyClusterSingleServerAssignOfApp = function(app, request) {
        return $http({
            url: '/sentinel/cluster/assign/single_server/' + app,
            data: request,
            method: 'POST'
        });
    };
    ...
    this.applyClusterServerBatchUnbind = function(app, machineSet) {
        return $http({
            url: '/sentinel/cluster/assign/unbind_server/' + app,
            data: machineSet,
            method: 'POST'
        });
    };
